export const news = [
    {
        id:1,
        image: "./images/1.jpg",
        text: "Winter weather to hit mid-Atlantic fast, create trouble for commuters",
        description: "The conditions on Thursday morning could change in a hurry, with meteorologists comparing the expected change in the weather to flipping a switch.",
    },
    {
        id:2,
        image: "./images/2.jpg",
        text: "Another blast of dangerous winter weather in store for Southeast",
        description: "Less than a week after a winter storm pummeled parts of Georgia, the Carolinas and Virginia, AccuWeather forecasters are warning people in those places to brace for more snow and ice. Here's the latest on accumulation potential.",
    },
    {
        id:3,
        image: "./images/3.jpg",
        text: "45 years ago: The day it snowed in Miami",
